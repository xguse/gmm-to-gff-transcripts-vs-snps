# Gmm to Gff transcripts vs SNPs
...
```shell
$ git clone https://github.com/xguse/gmm-to-gff-transcripts-vs-snps.git
```

Or via downloading a [zip](https://github.com/xguse/gmm-to-gff-transcripts-vs-snps/archive/master.zip) of the repository via the project's [github page](https://github.com/xguse/gmm-to-gff-transcripts-vs-snps).
